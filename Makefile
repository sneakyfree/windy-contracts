...
validate:
	uv run python -m loom.validate schema/fixtures/windytalk/control.mcp.v1.json schema/fixtures/windytalk/hands.mcp.v1.json schema/fixtures/windy-word/control.mcp.v1.json schema/fixtures/windy-mind/ops.mcp.v1.json schema/fixtures/windy-agent/control.mcp.v1.json
